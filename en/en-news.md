---
layout: default
title: News | Burai Live
permalink: /en/news/
lang: en
description: >-
  Latest news and announcements from Burai Live — new services, partnerships, media coverage and more.
---
...
.nw-item { display: flex; gap: 2rem; padding: 1.75rem 0; border-bottom: 1px solid #e2e8f0; text-decoration: none; align-items: flex-start; transition: background 0.15s; }
...
@media (max-width: 600px) { .nw-body { padding: 2.5rem 1.25rem; } .nw-item { gap: 1rem; } .nw-item__date { min-width: 70px; font-size: 0.75rem; } }
</style>

<div class="nw-hero">
  <p class="nw-hero__label">News</p>
  <h1 class="nw-hero__h1">News</h1>
  <p class="nw-hero__sub">Latest announcements from Burai Live</p>
</div>
...
<div class="nw-body">
  ...
  {% for post in en_posts %}
    {% if post.tags contains 'news' or post.categories contains 'news' %}
  ...
  <div class="nw-empty">
    ...
    <p>News articles coming soon. Stay tuned.</p>
  </div>
  {% endif %}
</div>
