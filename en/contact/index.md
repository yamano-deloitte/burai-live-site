---
title: お問い合わせ | Burai Live
layout: default
permalink: /contact/
lang: ja
description: >-
  Burai Liveへのお問い合わせはこちら。DX・ISRドローン開発、AI・Web・クラウド、バックオフィスDXに関するご相談・お見積りをお受けしています。
---
...
@media (max-width: 800px) {
  .cp-body { grid-template-columns: 1fr; padding: 2rem 1.25rem; }
}
</style>

<div class="cp-hero">
  <p class="cp-hero__label">Contact</p>
  <h1 class="cp-hero__h1">お問い合わせ</h1>
  <p class="cp-hero__sub">ご質問・ご相談・お見積りなど、お気軽にご連絡ください</p>
</div>
...
<div class="cp-body">
  ...
  <div class="cp-info">
    <div class="cp-info-card">
      ...
      <div class="cp-info-card__title">メール</div>
    ...
    <div class="cp-info-card">
      ...
      <div class="cp-info-card__title">営業時間</div>
      <div class="cp-info-card__body">
        月曜日〜金曜日<br>
        午前9時〜午後5時（日本時間）
      </div>
